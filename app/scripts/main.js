...
$(function() {
    ...
    // [ ] STILL NEED TO DO SOMETHING WITH THIS WIKI TIMEOUT.
    /**
     ...
     */
    renderWikiDetails: function(data) {
...
var viewModel = {
    ...
    ArticleViewModel: function() {
         ...
         *
         */
        var getArticles = function(thePlace) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    var mappedArticles = $.map(data.query.geosearch, function(article) {
                        console.log(article);
                        return new Article(article);
                    });
                    self.articles(mappedArticles);
                    console.log(self.articles()[0].title());
                },
                error: function(e) {
                    console.log('I am the error: ' + e);
                }
            }).done(function() { console.log('articles length: ' + self.articles().length); });
    ...
    // Activates knockout.js
        ko.applyBindings(new viewModel.ArticleViewModel());
